...
// //fetch1.then(res => res.json()).then(res1 => console.log(res1))

// const result = Promise.race([fetch1, fetch2]);
// result.then(data => data.json()).then(res => console.log(res))
// // result.then(data => Promise.all(data.map(res => res.json())))
// // .then(resultts => console.log(resultts))
...
const str = "11222333444455556677889";

function findLuckyNums(nums) {
  const result = {};
